...
exports.app = app;
app.use(_express.default.json()); // Documentation

app.use('/api-docs', _swaggerUiExpress.default.serve, _swaggerUiExpress.default.setup(_swagger.default)); // Url image
